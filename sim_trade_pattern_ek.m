function [m, final_price, good_shares] = sim_trade_pattern_ek(lambda,tau,theta,sigma,code)%#codegen
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
Ngoods = 1000; % Adjust this number if it is running really slow (not too low though).
% For the Feenstra estimation, this does not need to be large. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This is specially adapted for the Feenstra Estimation. Need to compute
% good level shares...

rec_gd_share = zeros(Ngoods,Ncntry);
